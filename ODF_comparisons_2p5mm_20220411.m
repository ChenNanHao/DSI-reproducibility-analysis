...
people = People{aa};
    disp(append('Start working for ',People{aa}, '_2.5mm at ', datestr(datetime(now,'ConvertFrom','datenum'))))
    if aa > 11
...
% Pre
    cd(append('E:\dsi_data_7T_20200901_try\SRC_Batch\',people(13:end),'_pre_2p5mm'))
...
% figure(1)
% subplot(3,6,aa)
% imshow(imrotate(Fa0(:,:,20),-90),[0 1]);colormap hot
% figure(2)
% subplot(3,6,aa)
% imshow(imrotate(WMmask(:,:,20),-90),[0 1]);colormap hot
...
% Post
    cd(append('E:\dsi_data_7T_20200901_try\SRC_Batch\',people(13:end),'_post_2p5mm'))
    load(dir('*17.mat').name)
    for cc = 1:bb
...
people = People{aa};
save(append('ODF_info_25_',people(13:end)),'Fa0','Fa1','Fa2','Fa3','Fa4','singlefibermask','crossfibermask','facondition','index','dimension','odf_faces','odf_vertices');
save(append('ODF_info_25_',people(13:end),'p'),'Fa0p','Fa1p','Fa2p','Fa3p','Fa4p','indexp','dimension');
save(append('ODF_repro_25_',people(13:end)),'Pa1','Pa4','Px4_1','Px4_4','ODFsim');

disp(append('Finished working for ',People{aa}, '_2.5mm at ', datestr(datetime(now,'ConvertFrom','datenum'))))
clearvars
end
...
people = People{aa};
load(append('ODF_info_25_',people(13:end)),'singlefibermask','crossfibermask');
load(append('ODF_repro_25_',people(13:end)));
